...
\usepackage[A4, margin=2cm]{geometry}
...
\begin{figure}[h]
    \textit{\caption{}}
    \centering
    \includegraphics[width=6cm, height=4cm]{math ex30 a.1 schéma.png}
\end{figure}
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[width=8cm, height=6cm]{math ex30 a.2 schéma.png}
\end{figure}
...
\begin{figure}[h]
    \textit{\caption{}}\vspace{0.2cm}
    \centering
    \includegraphics[width=4cm, height=4cm]{math ex30 a.3 schéma.png}
\end{figure}
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[width=6cm, height=6cm]{math ex30 d. schéma.png}
\end{figure}
