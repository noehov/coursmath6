...
\begin{figure}[h]
    \textit{\caption{La trajectoire du point $M$ est un arc de cercle d'équation $\displaystyle C_M \equiv x^2+y^2=5$}}\vspace{0.2cm}
    \centering
...
\begin{figure}[h]
    \textit{\caption{La trajectoire du point $P$ se trouve sur une ellipse d'équation $\displaystyle E_P \equiv 900x^2+100y^2=5624$}}\vspace{0.2cm}
    \centering
...
\begin{figure}[h]
    \textit{\caption{La trajectoire du point $Q$ se trouve sur une ellipse d'équation $\displaystyle E_Q \equiv 100x^2+900y^2=5624$}}\vspace{0.2cm}
    \centering
