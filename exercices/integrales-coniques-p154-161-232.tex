...
%----------------------------------------------------------------------------------------------------------------------------------------
\flushleft \textbf{a.1) Établir la formule permettant de calculer le volume d'un cylindre droit de rayon $R$ et de hauteur $h$}
\begin{figure}[h]
    \textit{\caption{}}
    \centering
...
\newpage
%----------------------------------------------------------------------------------------------------------------------------------------
\flushleft \textbf{a.2) Établir la formule permettant de calculer le volume d'une sphère de rayon $R$}
...
\newpage
%----------------------------------------------------------------------------------------------------------------------------------------
\flushleft \textbf{a.3) Établir la formule permettant de calculer le volume d'un cône droit de rayon $R$ et de hauteur $h$}

\begin{figure}[h]
    \textit{\caption{}}\vspace{0.2cm}
    \centering
    \includegraphics[width=6cm, height=6cm]{assets/ex30-a3-schema.png}
\end{figure}
Pour trouver la fonction, nous savons que $f(a)=f(0)=R$ et que $f(b)=f(h)=0$\vspace{0.5cm}
...
$$\displaystyle{\pi\times4R^3\over{3}}\times{1\over{\pi \times 2R^3}}={2\over{3}}$$

%----------------------------------------------------------------------------------------------------------------------------------------
\flushleft \textbf{d. Un tore est un solide de révolution engendré par un cercle tournant autour d'une droite située dans son plan mais ne passant pas par son centre. Montre que le volume $V$ d'un tore engendré par le mouvement d'un cercle de rayon $R$ et dont le centre est situé à une distance $a$ de la droite autour de laquelle il tourne, est donné par $V=2a\pi^2 R^2$.}\vspace{0.5cm}

Pour réaliser cet exercice, nous avons besoin des fonctions $\displaystyle f(x)=\sqrt{R^2-x^2}+a$ et $g(x)=-\sqrt{R^2-x^2}+a$
...
\flushleft \textbf{e. Un \textit{segment sphérique} est une portion de sphère coupée par deux plans parallèles. Montrer que le volume $V$ du segment sphérique de largeur $h$ et de rayon $a$ et $b$, engendré par la rotation autour de l'axe $Ox$ de la surface est donné par}
...
Le rayon des cercles inférieur et supérieur sont appelés respectivement $a$ et $b$. 
...
\begin{figure}[h]
    \textit{\caption{$\displaystyle f(x)=\sqrt{36-x^2}$}}\vspace{1cm}
    \centering
...
\begin{figure}[h]
    \textit{\caption{La trajectoire du point $M$ est un arc de cercle d'équation $\displaystyle C_M \equiv x^2+y^2=25$}}\vspace{0.2cm}
    \centering
...
\begin{figure}[h]
    \textit{\caption{La trajectoire du point $P$ se trouve sur une ellipse d'équation $\displaystyle E_P \equiv 900x^2+100y^2=5625$}}\vspace{0.2cm}
    \centering
...
%----------------------------------------------------------------------------------------------------------------------------------------
\begin{flushleft}
c. Même question avec le point $Q$ situé au quart de l'échelle à partir du pied.
\end{flushleft}

\begin{figure}[h]
    \textit{\caption{La trajectoire du point $Q$ se trouve sur une ellipse d'équation $\displaystyle E_Q \equiv 100x^2+900y^2=5625$}}\vspace{0.2cm}
    \centering
...
Les figures 3, 4, 6, 7, 8 et 9 ont été construites sur \textit{GeoGebra}.\vspace{0.2cm}
